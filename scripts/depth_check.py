...
saying what is in it, a command that would put a card on file, or a hub that quietly went back to
teaching.
...
EXEMPT_HEADINGS = re.compile(
    r"when it breaks|check yourself|verify|budget|ledger|the map|traps", re.I
)
